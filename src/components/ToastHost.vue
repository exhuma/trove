...
<template>
  <!-- aria-live so the outcome of an action reaches screen readers too, not
       just sighted users. -->
  <div class="pointer-events-none fixed inset-x-0 bottom-0 z-[60] flex flex-col items-center gap-2 p-4" aria-live="polite">
    <TransitionGroup
    ...
    >
      <div
        ...
        :key="toast.id"
        class="pointer-events-auto flex items-center gap-3 rounded-lg border px-4 py-2.5 shadow-xl"
